...
<html>
	...
	<body>
		<div id="my404" style="position: fixed; font-size: 72px;"><span id="id1">4</span><span id="id2">0</span><span id="id3">4</span><span id="id4">@</span><span id="id5">MouseChsh.com</span></div>
	</body>
	<script>
		( function(){

			var m4 = document.getElementById( 'my404' );
